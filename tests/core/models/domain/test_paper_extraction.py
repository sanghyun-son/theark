...
class TestPaperMetadata:
    ...
    def test_create_paper_metadata_success(self) -> None:
    ...
    def test_create_paper_metadata_with_optional_fields(self) -> None:
    ...
    def test_create_paper_metadata_missing_required_fields(self) -> None:
