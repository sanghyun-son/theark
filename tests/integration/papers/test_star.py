"""Integration tests for star functionality."""
...
class TestPaperStarIntegration:
    """Integration tests for star functionality."""

    @pytest.mark.asyncio
    async def test_star_lifecycle_end_to_end(self, integration_client: TestClient):
        """Test complete star lifecycle: create paper, add star, check status, remove star."""
        # First, create a paper via streaming
        ...
        starred_paper = next(
            (p for p in data["papers"] if p["paper_id"] == paper_id), None
        )
    ...
    @pytest.mark.asyncio
    async def test_star_nonexistent_paper(self, integration_client: TestClient):
    ...
    @pytest.mark.asyncio
    async def test_starred_papers_pagination(self, integration_client: TestClient):
    ...
    @pytest.mark.asyncio
    async def test_star_without_note(self, integration_client: TestClient):
