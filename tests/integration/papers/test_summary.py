...
@pytest.mark.asyncio
async def test_stream_paper_summary_basic_structure(integration_client: TestClient):
...
@pytest.mark.asyncio
async def test_stream_paper_summary_with_summarization(integration_client: TestClient):
...
@pytest.mark.asyncio
async def test_stream_paper_summary_invalid_url(integration_client: TestClient):
...
@pytest.mark.asyncio
async def test_get_summary_success(integration_client: TestClient):
...
@pytest.mark.asyncio
async def test_get_summary_not_found(integration_client: TestClient):
...
@pytest.mark.asyncio
async def test_mark_summary_as_read_success(integration_client: TestClient):
...
@pytest.mark.asyncio
async def test_mark_summary_as_read_not_found(integration_client: TestClient):
