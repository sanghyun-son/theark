...
class TestErrorHandler:
    ...
    def test_handle_api_operation_value_error_with_not_found(self):
    ...
    @pytest.mark.asyncio
    async def test_handle_async_api_operation_success(self):
    ...
    @pytest.mark.asyncio
    async def test_handle_async_api_operation_value_error(self):
    ...
    @pytest.mark.asyncio
    async def test_handle_async_api_operation_value_error_with_not_found(self):
    ...
    @pytest.mark.asyncio
    async def test_handle_async_api_operation_unexpected_error(self):
